defmodule WorkerTest do
  ...
  test "get a valid url" do
    ...
    Axe.Worker.get(self, "https://localhost:8433/get", [], "", :insecure)
    assert_receive {:ok, data }, 1000
  ...
  test "get an url returning an error code" do
    ...
    Axe.Worker.get(self, "https://localhost:8433/status/500", [], "", :insecure)
    assert_receive  {:ok, response }, 1000
    assert response.status_code == 500
    assert response.body == "Internal Server Error"
    assert response.resp_headers != nil
  ...
  test "follows a redirection" do
    ...
    Axe.Worker.get(self, "https://localhost:8433/redirect-to?url=https://localhost:8433/get", [], "", :insecure)
    assert_receive {:ok, response}, 1000
  ...
  test "follows several redirection" do
    ...
    Axe.Worker.get(self, "https://localhost:8433/redirect/4", [], "", :insecure)
    assert_receive {:ok, response}, 1000
    assert_https_response(response)
  end
  ...
  test "follows several relative redirections" do
    ...
    Axe.Worker.get(self, "https://localhost:8433/relative-redirect/4", [], "", :insecure)
    assert_receive {:ok, response}, 1000
    assert_https_response(response)
  end
  ...
  test "supports basic authentication" do
    ...
    Axe.Worker.get(self, "https://user:password@localhost:8433/basic-auth/user/password", [], "", :insecure)
    assert_receive {:ok, response}, 1000
    assert response.status_code == 200
  end
